      ...
      <div style={{ backgroundColor: "rgba(0, 0, 0, 0.7)" }} className="h-100">
        <AboutContainer className="container ">
          ...
          <Grid>
            <AboutThisProject>
              <p>
                This project was done during the January 2022 edition of the
                coding bootcamp at hack academy and during the sprint related to
                React. Gradually i putt into practice all the knowledge acquired
